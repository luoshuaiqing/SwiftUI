...
extension User {
    static var MOCK_USERS: [User] = [
        ...
        .init(id: UUID().uuidString, username: "blackpanther", profileImageUrl: "placeholder-blackpanther", fullname: "Black Panther", bio: "black panther", email: "blackpanther@gmail.com"),
